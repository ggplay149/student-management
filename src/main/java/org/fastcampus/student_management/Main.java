...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //더미 Data
    StudentInfoDto studentDto1 = new StudentInfoDto("유승현",33,"노원구");
    StudentInfoDto studentDto2 = new StudentInfoDto("유지현",30,"강남구");
    studentService.saveStudent(studentDto1);
    studentService.saveStudent(studentDto2);

    CourseInfoDto courseDto1 = new CourseInfoDto("수학",55555,"SUNDAY","유승현",12L);
    CourseInfoDto courseDto2 = new CourseInfoDto("영어",666666,"SUNDAY","유지현",13L);
    courseService.registerCourse(courseDto1);
    courseService.registerCourse(courseDto2);
